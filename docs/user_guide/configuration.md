...
With the batched-decode kernel explicitly enabled (`SPYRE_BATCHED_DECODE=1`; it is
disabled by default), warmup also records it over the KV-length × num-sequences grid.
